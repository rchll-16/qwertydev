...
const projects: Project[] = [
  {
    ...
    description: 'A modern, responsive website built as a capstone project for Molave Street Barbers. The site features a clean design, service showcases, and intuitive navigation—focused on delivering a polished user experience across desktop and mobile devices.',
  ...
  },
  {
    ...
    description: 'A professional and fully responsive corporate website developed for Rapido Solutions. Designed to clearly present the company’s services, brand identity, and contact information with a clean layout and smooth user experience across all devices.',
    tech: ['React', 'JavaScript', 'Tailwind', 'Supabase'],
  ...
  {
    title: 'Flower Shop',
    description: 'The Flower Shop is a static website designed to showcase a variety of flowers available for purchase. This website provides users with an easy-to-navigate interface to explore different flower types, view details, and make inquiries.',
  ...
  },
  {
    ...
    description: 'An E-Commerce bookstore web application where users can browse, search, and purchase books online. Built with React, Node.js, and MongoDB — providing a smooth, and dynamic shopping experience.',
  ...
  },
  {
    ...
    description: 'A clean user-friendly clothing site built with HTML and CSS. This static web project showcases a landing page, FAQ section, and styling using custom CSS.',
    tech: ['HTML', 'CSS'],
  ...
  },
  {
    ...
    description: 'A clean and informative school website crafted with HTML and CSS. Featuring multiple pages—Home, About, Academic Programs, Offers, Contacts.',
    tech: ['HTML', 'CSS'],
  ...
  },
  {
    ...
    description: 'A clean and informative school website built using HTML and CSS. Ideal for institutional presentation, this static site includes pages for home, about, academic programs, events, and contact details.',
    tech: ['HTML', 'CSS'],
  ...
  },
  {
    ...
    description: 'A beautifully designed, static website showcasing the heritage sites of Intramuros using HTML, CSS, and high-quality images. Perfect for both educational presentation and visual storytelling of historical landmarks.',
    tech: ['HTML', 'CSS'],
  ...
  },
  {
    ...
    description: 'A clean, educational website designed to present various science topics using HTML and CSS. Perfect for sharing lesson modules such as the water cycle, biodiversity, pollution, and more in a readable, structured format.',
    tech: ['HTML', 'CSS'],
  ...
  {
    title: 'Bini (Redesign)',
    description: 'A clean, modern redesign project for BINI, focusing on visually appealing layout, and smooth user experience. Built entirely with HTML, CSS, and JavaScript — no frameworks, just handcrafted code.',
    tech: ['HTML', 'CSS', 'JavaScript'],
